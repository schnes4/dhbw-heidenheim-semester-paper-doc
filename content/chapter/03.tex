...
Der für die Propellerdetektion zuständige \ac{IR} ist an einem eigenen Arduino verbunden.
Um Interrupts zwischen beiden Arduinos senden zu können sind diese miteinander verbunden.
